...
export default function CreditCard({
  ...
  return (
    <div
      ...
      } lg:w-[231px] xl:w-[345px] lg:h-[170px] xl:h-[230px] rounded-3xl flex-initial border border-[#DFEAF2]   text-white overflow-hidden 
      `}
    >
      <div className="flex flex-col lg:space-y-4 xl:space-y-10 lg:pb-3 xl:pb-6 px-4 lg:pt-4 xl:pt-6">
