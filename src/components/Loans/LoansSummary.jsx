...
export default function LoansSummary() {
  return (
    <div className="w-[992px] min-[833px]:w-full lg:w-[775px] min-[1070px]:w-full flex items-center justify-between">
      {/* Personal Laons */}
      <div className="w-[23.18%] bg-white rounded-[20px] xl:rounded-3xl flex items-center justify-start space-x-3 xl:justify-between px-8 min-[833px]:p-3.5 py-5 xl:p-5">
